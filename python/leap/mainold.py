    ...
    if leap.position.all > 0:
        ...
        for i in range(5):
            if leap.ftposition[i].all > 0:
                ...
                for j in range(4):
                    glVertex3f((leap.bone[i][j][0]*2-0.5)*width,(leap.bone[i][j][1]*2-0.5)*width,((leap.bone[i][j][2])*2-0.5)*depth)
                glEnd()
                glLineWidth(2)
        ...
        glBegin(GL_LINE_STRIP)                
        for i in range(5):
            glVertex3f((leap.bone[i][0][0]*2-0.5)*width,(leap.bone[i][0][1]*2-0.5)*width,((leap.bone[i][0][2])*2-0.5)*depth)
        glEnd()
        glBegin(GL_LINE_LOOP)
        glVertex3f((leap.arm[1][0]*2.0-0.5)*width,(leap.arm[1][1]*2.0-0.5)*height,((leap.arm[1][2])*2.0-0.5)*depth)
        glVertex3f((leap.bone[0][0][0]*2-0.5)*width,(leap.bone[0][0][1]*2-0.5)*width,((leap.bone[0][0][2])*2-0.5)*depth)
        glVertex3f((leap.arm[1][0]*2.0-0.5)*width,(leap.arm[1][1]*2.0-0.5)*height,((leap.arm[1][2])*2.0-0.5)*depth)
        glVertex3f((leap.bone[4][0][0]*2-0.5)*width,(leap.bone[4][0][1]*2-0.5)*width,((leap.bone[4][0][2])*2-0.5)*depth)
        glEnd()      
